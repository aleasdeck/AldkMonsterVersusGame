...
describe('редкий тир в пуле акта (loot.ts, v0.35)', () => {
  it('акт 2: обычная награда, торговец и сундук с шансом 15 % дают мифический предмет; элита и другие акты — как раньше', () => {
    ...
    expect(mythic / gear).toBeGreaterThan(0.1);
    expect(mythic / gear).toBeLessThan(0.2);
