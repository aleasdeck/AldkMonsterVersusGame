...
- **Палитра.** Готовые файлы квантуются: листы героев в 256 цветов, аватарки и фоны в 128 (`--colors` у всех трёх скриптов, `0` — оставить полный цвет). Лист Мага в полном цвете весил 1.7 МБ и качался ровно в тот момент, когда героя надо показать; в палитре — 355 КБ при ошибке цвета 4–6 из 255, а на экране разницы нет, потому что листы и аватарки выводятся со сглаживанием.
