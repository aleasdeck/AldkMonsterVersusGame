...
- `docs/adr/` — разборы отложенных решений: что выяснено, какие варианты рассмотрены и почему пока не делаем. Сейчас там `0001-obshchie-sidy.md` (почему один сид не даёт одинаковый забег и как это чинить).
