...
/**
 * Враги пиксельной лепки в игре: Лес (v0.52) и Болота (v0.52.2). Лист врага — три ряда кадров (покой, удар, урон),
 ...
 */
export const MOB_MODELS: Record<string, Model> = { ...FOREST_MODELS, ...SWAMP_MODELS };
