...
function statRows(s: DerivedStats, hp: number): HTMLElement[] {
  ...
  const rows: (HTMLElement | null)[] = [
    ...
    row('Дальность', s.reachAny ? 'любая цель' : 'первый в ряду', 'Кого достают удар и физические приёмы: ближнее оружие бьёт только первого в ряду, дальнее, магическое и копьё — любого врага. Заклинания и склянки достают любого всегда'),
