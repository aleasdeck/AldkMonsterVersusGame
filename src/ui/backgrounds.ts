...
/**
 * Рисованные фоны (v0.41.1): мастер генератора лежит в `art/<локация>-bg.png`,
 ...
 * Процедурные фоны, жившие здесь до v0.41.1, удалены (есть в истории): арт теперь у всех шести локаций,
