...
const KEYWORDS: Keyword[] = [
  ...
  { re: word('крит[а-яё]*'), title: 'Крит', text: 'Критический удар: урон × крит. урон героя (от 150 %). Верный крит выпадает наверняка: удар в спину, удар по оглушённому или скованному льдом, Верный глаз.' },
