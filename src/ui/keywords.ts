...
/**
 * Подсказка статуса с числом (v0.52): «N урона в начале хода» у Кровотечения 4 становится «4 урона в начале хода».
...
/**
 * Подсказка ключевого слова (v0.52): иконка и имя цветом статуса, правило абзацем. value — число сразу за словом
