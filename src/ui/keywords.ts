...
const KEYWORDS: Keyword[] = [
  ...
  { re: word('крит[а-яё]*'), title: 'Крит', text: 'Критический удар: урон × крит. урон героя (от 150 %). Верный крит выпадает наверняка: удар в спину, Верный глаз, удар по оглушённому с «Оглушающим ударом» или «Хладнокровием».' },
  ...
  { re: word('удар в спину'), title: 'Удар в спину', text: 'Атака из скрытности: всегда крит и мимо блока врага, после неё герой виден.' },
];
