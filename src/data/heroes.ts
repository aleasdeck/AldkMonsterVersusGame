...
const list: HeroDef[] = [
  ...
  },
  {
    id: 'berserk',
    name: 'Берсерк',
    role: 'Почти без защиты и без маны. Ярость даёт лишние действия и Силу ценой своей крови; серия ударов за ход теряет мало урона.',
    hp: 44,
    def: 3,
    mp: 0,
    mpRegen: 0,
    ...
    armor: { base: 'harness', name: 'Шкура', def: 0, hp: 0 },
