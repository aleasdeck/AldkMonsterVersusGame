...
const list: HeroDef[] = [
  ...
  },
  {
    ...
    critDmg: 190,
    name: 'Ассасин',
    role: 'Входит в бой в тени: враги его не видят, а любая атака из скрытности — удар в спину, всегда крит. Дымовая шашка возвращает в тень (сроки скрытности складываются), яд не выдаёт.',
    hp: 31,
