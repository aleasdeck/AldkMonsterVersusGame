...
/**
 * Надбавка к урону врагов по акту поверх приведения: +25 % в первом, +45 % во втором, +60 % в третьем.
 * Снижена с 1.4 / 1.6 / 1.75 в v0.21: крит перестал быть удвоением урона (150 % базы вместо ×2),
 * и без этой правки бот терял 5–11 пунктов побед на каждом герое.
 */
export const ACT_DMG_BONUS: [number, number, number] = [1.25, 1.45, 1.6];
