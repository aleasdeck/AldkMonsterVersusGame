...
/**
 * Надбавка к урону врагов по акту поверх приведения: +30 % в первом, +50 % во втором, +65 % в третьем.
 * Подобрана умным ботом-симулятором (v0.10, тогда 1.4 / 1.6 / 1.75): с прежними 1 / 1.15 / 1.15 он выигрывал 91–97 % забегов,
 * с блоком 80 % — 42–58 %. В v0.21 снижена на 0.1 в каждом акте: боссы получили вторые фазы, давление переехало на них.
 */
export const ACT_DMG_BONUS: [number, number, number] = [1.3, 1.5, 1.65];
