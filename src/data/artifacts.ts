...
const list: ArtifactDef[] = [
  ...
  },
  {
    ...
    glyph: '◐',
    kind: 'passive',
    mods: (tier) => ({ def: t(2, 4, 6)(tier) }),
    describe: (tier) => `+${t(2, 4, 6)(tier)} к Защите (блок за «Защититься»)`,
  },
  {
    id: 'mana_crystal',
    name: 'Кристалл маны',
  ...
  // ─── Активные физические (STA) ───────────────────────────────────────────
  {
    ...
    cost: { sta: 2 },
    target: 'enemy',
    effects: (tier) => [{ type: 'attack', bonus: t(4, 7, 10)(tier), target: 'enemy' }],
    describe: (tier) => `Атака +${t(4, 7, 10)(tier)} урона по цели`,
  },
  {
    id: 'whirlwind',
    name: 'Вихрь',
  ...
  },
  {
    ...
    cost: { sta: 1 },
    target: 'enemy',
    effects: (tier) => [{ type: 'status', target: 'enemy', status: 'bleed', value: t(2, 3, 4)(tier), turns: 3 }],
    describe: (tier) => `Кровотечение ${t(2, 3, 4)(tier)} на 3 хода`,
  },
  {
    id: 'war_cry',
    name: 'Боевой клич',
    ...
    cost: { sta: 1 },
    target: 'self',
    effects: (tier) => [{ type: 'status', target: 'self', status: 'strength', value: t(1, 2, 3)(tier), turns: -1 }],
    describe: (tier) => `+${t(1, 2, 3)(tier)} к Силе до конца боя`,
  },
  {
    id: 'second_wind',
    name: 'Второе дыхание',
  ...
  // ─── Активные магические (MP) ────────────────────────────────────────────
  {
    ...
    describe: (tier) => `${t(7, 10, 13)(tier)} урона заклинанием`,
  },
  {
    id: 'ice_shard',
    ...
    describe: (tier) => `${t(3, 5, 7)(tier)} урона и Слабость на ${t(1, 2, 3)(tier)} ход(а)`,
  },
  {
    id: 'heal',
    name: 'Лечение',
    ...
    cost: { mp: 3 },
    target: 'self',
    effects: (tier) => [{ type: 'heal', amount: t(5, 8, 12)(tier) }],
    describe: (tier) => `Восстанавливает ${t(5, 8, 12)(tier)} HP`,
  },
  {
    id: 'mana_shield',
    name: 'Магический щит',
  ...
  },
  {
    ...
    describe: (tier) => `${t(4, 6, 8)(tier)} урона, лечит на столько же`,
  },
  {
    id: 'dodge',
    name: 'Уклонение',
