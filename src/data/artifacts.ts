...
const list: ArtifactDef[] = [
  ...
  },
  {
    ...
    describe: (tier) => `Следующий удар оружием в этом ходу повторяется: атака, удары приёма, Финишер, Таран, Пролом щита и Цепная атака бьют дважды, усталость считает их одной атакой. Заклинания не повторяет. КД ${t(4, 3, 2)(tier)}`,
  },
  {
    id: 'chain_strike',
    fx: { color: '#c9ccd1' },
