...
// бронные — HP, ресурсы (мана, стамина), блок, лечение, защита. Ловчая сеть — бронная (Слабость гасит урон врагов),
// Сглаз — оружейный (Уязвимость растит свой), Волчий свисток — бронный (волк принимает удары первым).
