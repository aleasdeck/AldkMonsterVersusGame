...
const list: ArtifactDef[] = [
  ...
  },
  {
    ...
    tags: ['shadow'],
    keystone: true,
    // Верный крит по оглушённому — свой (v0.51.1), без «Оглушающего удара»: так ключевая вещь задумана (план §2), и так она
    // сходится с «Засадой» — чертой, что открывается мастерством Лучника вместе с ней. Иначе оглушение Засады и пращи крита не давало.
    mods: () => ({ critDmg: 100, critOnlySure: 1, stunCrit: 1 }),
    describe: () => 'Крит. урон +100 %; случайного крита нет, только верный; удары по оглушённому — всегда крит',
  },
  {
    id: 'frost_blade',
    name: 'Ледяной клинок',
